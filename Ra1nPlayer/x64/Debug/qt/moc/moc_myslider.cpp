...
QT_MOC_LITERAL(1, 9, 12), // "SliderChange"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 9) // "position_"

    },
    "MySlider\0SliderChange\0\0position_"
};
...
void MySlider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SliderChange((*reinterpret_cast< double(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MySlider::SliderChange)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MySlider::SliderChange(double _t1)
{
