/****************************************************************************
** Meta object code from reading C++ file 'OpenglRender.h'
**
...
#error "The header file 'OpenglRender.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_OpenglRender_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_OpenglRender_t qt_meta_stringdata_OpenglRender = {
    {
QT_MOC_LITERAL(0, 0, 12), // "OpenglRender"
QT_MOC_LITERAL(1, 13, 10), // "frameReady"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 8), // "AVFrame*"
QT_MOC_LITERAL(4, 34, 5), // "frame"
QT_MOC_LITERAL(5, 40, 12) // "onFrameReady"

    },
    "OpenglRender\0frameReady\0\0AVFrame*\0"
    "frame\0onFrameReady"
};
...
void OpenglRender::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->frameReady((*reinterpret_cast< AVFrame*(*)>(_a[1]))); break;
        case 1: _t->onFrameReady((*reinterpret_cast< AVFrame*(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (OpenglRender::*)(AVFrame * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OpenglRender::frameReady)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject OpenglRender::staticMetaObject = { {
    QMetaObject::SuperData::link<QOpenGLWidget::staticMetaObject>(),
    qt_meta_stringdata_OpenglRender.data,
...
// SIGNAL 0
void OpenglRender::frameReady(AVFrame * _t1)
{
