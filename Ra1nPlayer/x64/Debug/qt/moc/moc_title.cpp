...
QT_MOC_LITERAL(1, 6, 9), // "MenuClick"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 11), // "MinBtnClick"
QT_MOC_LITERAL(4, 29, 12), // "FullBtnClick"
QT_MOC_LITERAL(5, 42, 13), // "CloseBtnClick"
QT_MOC_LITERAL(6, 56, 13) // "OpenFileClick"

    },
    "Title\0MenuClick\0\0MinBtnClick\0FullBtnClick\0"
    "CloseBtnClick\0OpenFileClick"
};
...
void Title::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->MinBtnClick(); break;
        case 2: _t->FullBtnClick(); break;
        case 3: _t->CloseBtnClick(); break;
        ...
        {
            using _t = void (Title::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Title::MenuClick)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Title::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Title::MinBtnClick)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Title::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Title::FullBtnClick)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (Title::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Title::CloseBtnClick)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (Title::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Title::OpenFileClick)) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 0
void Title::MenuClick()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Title::MinBtnClick()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void Title::FullBtnClick()
{
    QMetaObject::activate(this, &staticMetaObject, 2, nullptr);
}

// SIGNAL 3
void Title::CloseBtnClick()
{
    QMetaObject::activate(this, &staticMetaObject, 3, nullptr);
}

// SIGNAL 4
void Title::OpenFileClick()
{
